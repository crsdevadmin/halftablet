...
export const PROGRAMS: AssistanceProgram[] = [
  ...
  {
    id: 'pharma-targeted-access',
    name: 'Targeted Therapy Access Programs',
    sponsor: 'Pharma manufacturer programs (e.g. for osimertinib, palbociclib, olaparib)',
    type: 'pharma',
    categories: [],
    maxIncomeBand: '3l-8l',
    excludesInsured: false,
    benefit: 'Buy-X-get-Y-free cycles or capped total treatment cost for high-price targeted therapies',
    documents: ['Oncologist prescription', 'Diagnosis/biomarker report', 'Income proof', 'Aadhaar'],
  ...
  {
    id: 'ngo-supportive-care',
    name: 'NGO Supportive Care Funds',
    sponsor: 'NGO networks (state-specific)',
    type: 'ngo',
    categories: ['supportive'],
    maxIncomeBand: '3l-8l',
    excludesInsured: false,
    benefit: 'Subsidised supportive-care injections (G-CSF, anti-nausea kits) and nutrition supplements at partner centres',
    documents: ['Oncologist prescription', 'Income proof'],
    howToApply: 'HalfTablet patient support can connect you to partner NGOs in your state.',
  },
  {
    id: 'ngo-cml-access',
    name: 'CML / GIST International Access Program',
    sponsor: 'International patient-access foundations (e.g. for imatinib)',
    type: 'ngo',
    categories: ['blood-cancer'],
    maxIncomeBand: '3l-8l',
    excludesInsured: false,
    benefit: 'Free branded imatinib for eligible CML and GIST patients for the full treatment duration',
    documents: ['Haematologist/oncologist prescription', 'BCR-ABL / diagnosis report', 'Income assessment'],
    howToApply: 'Your treating oncologist registers you with the program\'s local partner.',
  },
  {
    id: 'ngo-cancer-fund',
